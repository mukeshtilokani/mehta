<head>
    ...
    <!-- Stylesheets -->
    <link rel="stylesheet" id="css-main" href="{{ asset('backend/assets/css/bootstrap.min.css') }}">
    ...
    <link rel="stylesheet" id="css-main" href="{{ asset('backend/assets/css/common.css') }}">
